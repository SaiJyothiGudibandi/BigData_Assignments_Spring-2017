...
public class ClarifaiExample {
    public static void main(String[] args) throws IOException {
        ...
        final ClarifaiClient client = new ClarifaiBuilder("9N663ExKhwGN3ervWgY-dp5ONSBsninWuXK1mkC_", "2PShBo_78rD0JLiPpKnBfd295zTuJ_V_s_1dj0wU")
        ...
        ClarifaiResponse response = client.getDefaultModels().generalModel().predict()
                .withInputs(
                        ClarifaiInput.forImage(ClarifaiImage.of(new File("input/new30.jpg")))
                )
                .executeSync();
        ...
        if (predictions.isEmpty()) {
            ...
            MBFImage image = ImageUtilities.readMBF(new File("input/new30.jpg"));
